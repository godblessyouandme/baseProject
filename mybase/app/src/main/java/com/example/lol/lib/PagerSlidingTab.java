...
public class PagerSlidingTab extends HorizontalScrollView {
	...
	private int underlineColor = 0x1A000000;//下边一条线的颜色
	...
	private int indicatorHeight = 2;//指示线的高度(宽度)
	private int underlineHeight = 2;
	private int dividerPadding = 16;
	private int tabPadding = 15;
	private int dividerWidth = 1;

	private int tabTextSize = 18;//标题的字体
	private int tabTextColor = 0xFF666666;//文字颜色#F59724
	private Typeface tabTypeface = null;
	private int tabTypefaceStyle = Typeface.BOLD;

	private int lastScrollX = 0;

	private int tabBackgroundResId = R.drawable.backgroundtab;
	...
	public PagerSlidingTab(Context context, AttributeSet attrs, int defStyle) {
		...
		tabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTab_tabBackground2, tabBackgroundResId);
